...
class TestAttributes:
    ...
    def test_direction(self):
        assert DiurnalDTWFidelity().direction == "min"

    def test_name(self):
        assert DiurnalDTWFidelity().name == "diurnal_dtw"
...
class TestScore:
    ...
    def test_full_selection_low(self, component, all_slices_combo):
