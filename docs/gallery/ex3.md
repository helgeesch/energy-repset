...
<iframe src="output_pareto_scatter.html" width="100%" height="500" frameborder="0"></iframe>

#### Pareto Parallel Coordinates
All objectives shown as parallel axes.
<iframe src="output_pareto_parallel.html" width="100%" height="500" frameborder="0"></iframe>

#### Score Contributions
Normalized contributions of each score component.
<iframe src="output_score_contributions.html" width="100%" height="500" frameborder="0"></iframe>

### Feature Space

#### Feature Scatter with Selection
First two feature columns with selected days highlighted.
<iframe src="output_feature_scatter.html" width="100%" height="500" frameborder="0"></iframe>

### Distribution Fidelity (ECDF)

#### Load
<iframe src="output_ecdf_load.html" width="100%" height="500" frameborder="0"></iframe>

#### Onshore Wind
<iframe src="output_ecdf_onwind.html" width="100%" height="500" frameborder="0"></iframe>

#### Offshore Wind
<iframe src="output_ecdf_offwind.html" width="100%" height="500" frameborder="0"></iframe>

#### Solar
<iframe src="output_ecdf_solar.html" width="100%" height="500" frameborder="0"></iframe>
